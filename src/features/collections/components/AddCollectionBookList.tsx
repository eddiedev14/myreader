...
import { AddCollectionBookCard } from "./AddCollectionBookCard";
import { getVisibleNodes } from "@/features/books/utils/utils";
import {
  COLLECTION_PAGE_SIZE,
  VISIBLE_PAGES,
} from "@/features/collections/constants/collection.constants";
...
export function AddCollectionBookList({ books = [], onAddBook }: Props) {
  ...
  const totalPages = Math.ceil(books.length / COLLECTION_PAGE_SIZE);
