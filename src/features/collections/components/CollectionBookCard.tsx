...
import { useCollectionBookCard } from "../hooks/useCollectionBookCard";
...
export function CollectionBookCard({ book }: BookCardProps) {
  const {
    statesMessages,
    handleNavigateBook,
    handleEnqueueBook,
    handleRemoveFromCollection,
  } = useCollectionBookCard(book as BookDashboard);
