...
export const BookDetail = () => {
  const { book, creator, loading, imageError, setImageError } = useBookDetail();
  ...
  return (
    <section className="px-8 max-w-5xl grid grid-cols-2">
      <img
        src={book.bookCover}
      ...
      <div>
        ...
        <div className="mt-3 pb-6 border-b border-b-gray-300 flex gap-2">
          ...
          {book.genres.slice(1).map((genre) => (
            <span className="capitalize text-sm font-medium px-4 py-1 rounded-full border border-gray-700 text-gray-700">
